...
function getNewspapers(){
  instance.get('/system/printing-newspapers/').then(response => {
...
function deleteNewspaper(id){
  instance.delete(`/system/printing-newspapers/${id}/`).then(response => {
...
<template>
  <div class="d-flex align-center flex-column ga-10">
    ...
    <v-card
        width="400"
        :title="newspaper.newspaper"
        :subtitle="`Типография: ${newspaper.printer}`"
