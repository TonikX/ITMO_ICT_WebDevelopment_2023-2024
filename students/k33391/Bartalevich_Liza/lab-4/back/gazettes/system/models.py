...
class Aviary(models.Model):
    ...
    area = models.ForeignKey('system.Area', related_name='aviaries', on_delete=models.CASCADE,
...
class Animal(models.Model):
    ...
    vet = models.ForeignKey('system.Worker', related_name='vet_animals', on_delete=models.CASCADE,
                            null=True, blank=True)
    cleaner = models.ForeignKey('system.Worker', related_name='cleaned_animals', on_delete=models.CASCADE,
                                null=True, blank=True)
...
class Owning(models.Model):
    animal = models.OneToOneField('system.Animal', related_name='owning', on_delete=models.CASCADE, null=True, blank=True)
    in_lease = models.BooleanField()
    owner = models.ForeignKey('system.Zoo', related_name='owned_animals', on_delete=models.CASCADE, null=True, blank=True)
    here_now = models.ForeignKey('system.Zoo', related_name='animals_here', on_delete=models.CASCADE,null=True, blank=True)
...
class AnimalInAviary(models.Model):
    animal = models.OneToOneField('system.Animal', related_name='where', on_delete=models.CASCADE, null=True, blank=True)
    aviary = models.ForeignKey('system.Aviary', related_name='who', on_delete=models.CASCADE, null=True, blank=True)
