  ...
  <div class = "main-container">
      ...
      <h1>Рецепты</h1>
        <ul class="recipe-list">
          <li v-for="recipe in recipes" :key="recipe.id">
            ...
            <p><span class="label">Время приготовления:</span> <span class="value">{{ recipe.preparation_time }} min</span></p>
            <p><span class="label">Время готовки:</span> <span class="value">{{ recipe.cooking_time }} min</span></p>
            <p><span class="label">Сложность:</span> <span class="value">{{ recipe.difficulty_level }}</span></p>
            <p><span class="label">Страна:</span> <span class="value">{{ recipe.region }}</span></p>
            <p><span class="label">Вегетарианское:</span> <span class="value">{{ recipe.is_vegetarian ? 'Yes' : 'No' }}</span></p>
            <br><br>
            ...
            <br>
            <button @click="deleteRecipe(recipe.id)">Удалить</button>
            <button @click="startEdit(recipe)">Изменить</button>
          </li>
        </ul>
    ...
    <div class="form-container">
      ...
      <form @submit.prevent="createRecipe">
        ...
        <div>
          <label for="newRegion">Страна:</label>
          <input id="newRegion" type="text" v-model="newRecipe.region">
        </div>

        <div>
          <label for="newVegetarian">Вегетарианское:</label>
