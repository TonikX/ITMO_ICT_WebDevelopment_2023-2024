    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='turapp.tour')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='reserved_tours',
            field=models.ManyToManyField(through='turapp.Reservation', to='turapp.tour'),
        ),
        migrations.CreateModel(
            name='TourComment',
            fields=[
