    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='car_rent.car')),
        ...
        migrations.AddField(
            model_name='car',
            name='drivers',
            field=models.ManyToManyField(through='car_rent.Ownership', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='driver',
            name='cars',
            field=models.ManyToManyField(through='car_rent.Ownership', to='car_rent.car'),
        ),
        migrations.AddField(
            model_name='driver',
            name='groups',
