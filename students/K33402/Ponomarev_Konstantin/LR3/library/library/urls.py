...
urlpatterns = [
    ...
    path('taking_book/list', BookTakingListAPIView.as_view()),
    path('taking_book/give', BookTakingPostAPIView.as_view()),
    path('taking_book/delete/<int:pk>', BookTakingDeleteApiView.as_view()),
]
