...
<template>
  <div class="d-flex align-center flex-column ga-10">
    <h2>Назначения</h2>
    <template
      v-for="teacher_lesson in teachers_lessons"
      :key="teacher_lesson.id"
    >
      <v-card
        width="600"
        ...
        ><v-card-actions>
          ...
          <v-btn @click="deleteTeacher(teacher_lesson.id)"> Удалить </v-btn>
