  ...
  <div class="d-flex align-center flex-column ga-10">
    ...
    <template v-for="room in rooms" :key="room.id">
      <v-card
        ...
        ><v-card-actions>
          <v-btn @click="router.push('/rooms/' + room.num)"> Изменить </v-btn>
          <v-btn @click="deleteRoom(room.num)"> Удалить </v-btn>
