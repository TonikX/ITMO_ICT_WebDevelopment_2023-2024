...
def create_driver(request):
    if request.method == 'POST':
        ...
        form = DriverForm()
    return render(request, 'project_first_app/create_driver.html', {'form': form})
...
def update_driver(request, driver_id):
    ...
    return render(request, 'project_first_app/update_driver.html', {'form': form, 'driver': driver})
...
def delete_driver(request, driver_id):
    ...
    if request.method == 'POST':
        driver.delete()
        return redirect('driver_list')
    return render(request, 'project_first_app/delete_driver.html', {'driver': driver})
