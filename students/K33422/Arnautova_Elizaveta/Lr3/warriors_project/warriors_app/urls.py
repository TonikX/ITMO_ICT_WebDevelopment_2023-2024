...
urlpatterns = [
    ...
    path('warriors/info/', WarriorViewSet.as_view({'get': 'get_full_info'})),
    path('warriors/<int:pk>/',WarriorViewSet.as_view({'get': 'get_warrior_info', 'delete': 'delete_warrior', 'put': 'edit_warrior'})),
