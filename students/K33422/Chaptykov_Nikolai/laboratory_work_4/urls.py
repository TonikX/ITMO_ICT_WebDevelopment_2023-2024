...
urlpatterns = [
    ...
    path('login_js/', sign_in_js, name='login_js'),
    path('register_js/', sign_up_js, name='login_js'),
    path('group_js/', get_group_list, name='group_js'),
    path('group_js/<int:pk>', get_group_js, name='group_js'),
    path('tutor_js/', get_tutor_list, name='tutor_js'),
