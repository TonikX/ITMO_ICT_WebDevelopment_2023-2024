...
class UserCreateView(FormView):
    ...
    success_url = reverse_lazy('token_create')  # Redirect to the login page upon successful registration

    def form_valid(self, form):
        user = form.save()
        auth_login(self.request, user)  # Automatically log in the user upon successful registration
